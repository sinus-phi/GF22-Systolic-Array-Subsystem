####
# Didactic SoC FPGA prototyping flow for the local PYNQ-Z2 + FT232H + Nucleo
# setup using PYNQ-Z2 Arduino/Raspberry-Pi style general IO headers.
#
# This script is intentionally separate from run_xilinx.tcl and from the
# PMOD-based Z2 script so that the original school flow remains untouched.
####
...
set PROJECT z2_course_io_ft232h_nucleo
...
add_files -fileset constrs_1 -norecurse constraints/z2_course_io_ft232h_nucleo.xdc
