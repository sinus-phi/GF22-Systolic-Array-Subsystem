...
module group2_apb_if (
  ...
  // Decode is local to the selected Student_SS 64 KiB window. The SoC
  // interconnect already stripped the slot index, so the full 16-bit PADDR is
  // the subsystem-local offset.
