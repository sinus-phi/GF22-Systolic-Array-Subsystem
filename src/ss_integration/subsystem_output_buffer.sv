...
//
// subsystem_sa_ctrl writes one full row per beat. APB reads expose a
...
module subsystem_output_buffer #(
  ...
  function automatic logic [ROW_INDEX_WIDTH-1:0] decode_write_row_index(
    ...
    begin
      ...
      // subsystem_sa_ctrl presents byte-address-like row offsets:
      //   row 0 -> 0 * ROW_BYTES
      //   row 1 -> 1 * ROW_BYTES
      //   ...
