...
# setup. This standalone script is kept separate from run_xilinx.tcl so that
# the original school-provided Z1/Basys3 flow remains untouched.
####
...
add_files -fileset constrs_1 -norecurse constraints/z2_ft232h_nucleo.xdc
